...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("teacher_dashboard.t_add_lecture, Dashboard3", t_add_lecture.class, __md_methods);
	}
	...
	public t_add_lecture ()
	{
		...
		if (getClass () == t_add_lecture.class)
			mono.android.TypeManager.Activate ("teacher_dashboard.t_add_lecture, Dashboard3", "", this, new java.lang.Object[] {  });
	}
